      ...
      child: ListView(
        children: [
          ...
          ListTile(
            ...
            title: Text('Pet Details', style: TextStyle(fontSize: 18.sp,
                fontFamily: 'Sora')
            ),
            minLeadingWidth: 10,
            onTap: () {
          ...
          ListTile(
            ...
            title: Text('Doctor List', style: TextStyle(fontSize: 18.sp,
                fontFamily: 'Sora',
                fontWeight: FontWeight.w500)),
            minLeadingWidth: 10,
            onTap: () {
          ...
          ListTile(
            ...
            title: Text('Nearby Store', style: TextStyle(fontSize: 18.sp,
                fontFamily: 'Sora',
                fontWeight: FontWeight.w500)),
            minLeadingWidth: 10,
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=>ShopMaps()));
            },
          ),
          Divider(height: 30.0, color: Colors.blueGrey),
          ListTile(
            leading:Icon(FontAwesomeIcons.signOutAlt,color: iconColor),
            title:Text('Log-out',style:TextStyle(fontSize: 18.sp, fontFamily: 'Sora',
            fontWeight: FontWeight.w500)),
            minLeadingWidth: 10,

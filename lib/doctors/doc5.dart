...
class Doc5 extends StatefulWidget {
  const Doc5({Key? key}) : super(key: key);

  @override
  _Doc5State createState() => _Doc5State();
}

class _Doc5State extends State<Doc5> {
            ...
            child:Column(
              ...
              children: <Widget>[
                Container(
                    ...
                    child:Image(image:AssetImage('images/doc/doc5.png'),height: 200.h)
                ),
                Divider(
                  thickness:0.5.w,
                  color: Colors.black,
                ...
                Text('Doc. Rouf Khan',textAlign:TextAlign.center,style: TextStyle(fontFamily: 'Shadows Into Light',fontSize:22.sp)),
                Text('Exotic Animal Veterinary ',textAlign:TextAlign.center,style: TextStyle(fontFamily: 'Sora',color:Colors.blueGrey,fontSize: 16.sp),),
                Text('University Of Edinburgh',textAlign:TextAlign.center,style: TextStyle(fontFamily: 'Sora',color: Colors.blueGrey),),
                Divider(
                  thickness:0.5.w,
                  color: Colors.black,
                  indent: 50.w,
                  ...
                  child: Row(
                      ...
                      children:[
                        ...
                        Container(
                          ...
                          child: Column(
                              children:[
                                Text('13+',style:TextStyle(fontSize: 18.sp,fontFamily: 'montserrat')),
                                SizedBox(height:5.h),
                ...
                Container(
                    ...
                    child:Column(
                      ...
                      children: [
                        ...
                        Text('Dr. Rouf Khan is a highly qualified and experienced veterinarian from India. He is a specailist in treating Exotic Animals.',style: TextStyle(fontFamily: 'Montserrat',color:Colors.blueGrey)),
                      ],
                    )
                ),
                Padding(

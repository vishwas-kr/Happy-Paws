...
class Doc4 extends StatefulWidget {
  const Doc4({Key? key}) : super(key: key);

  @override
  _Doc4State createState() => _Doc4State();
}

class _Doc4State extends State<Doc4> {
            ...
            child:Column(
              ...
              children: <Widget>[
                Container(
                    ...
                    child:Image(image:AssetImage('images/doc/doc4.png'),height: 200.h)
                ),
                Divider(
                  thickness:0.5.w,
                  color: Colors.black,
                ...
                Text('Doc. Bhanupratap Singh',textAlign:TextAlign.center,style: TextStyle(fontFamily: 'Shadows Into Light',fontSize:22.sp)),
                Text('Veterinary Surgon & Animal Welfare ',textAlign:TextAlign.center,style: TextStyle(fontFamily: 'Sora',color:Colors.blueGrey,fontSize: 16.sp),),
                Text('Medical University,Chicago',textAlign:TextAlign.center,style: TextStyle(fontFamily: 'Sora',color: Colors.blueGrey),),
                Divider(
                  thickness:0.5.w,
                  color: Colors.black,
                  indent: 50.w,
              ...
              child: Row(
                  ...
                  children:[
                    ...
                    Container(
                      ...
                      child: Column(
                          children:[
                            Text('8+',style:TextStyle(fontSize: 18.sp,fontFamily: 'montserrat')),
                            SizedBox(height:5.h),
                ...
                Container(
                    ...
                    child:Column(
                      ...
                      children: [
                        ...
                        Text('Dr. Bhanupratap Singh is a highly qualified and experienced veterinarian from India. He ia veterinary surgon and a reputed member of Animal Welfare Community.',style: TextStyle(fontFamily: 'Montserrat',color:Colors.blueGrey)),
                      ],
                    )
                ),
                Padding(

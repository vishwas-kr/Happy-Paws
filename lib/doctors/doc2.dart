            ...
            child: Column(
              ...
              children: <Widget>[
                Container(
                    ...
                    child:Image(image:AssetImage('images/doc/doc2.png'),height: 200.h)
                ),
                Divider(
                  thickness:0.5.h,
                  color: Colors.black,
                ...
                Text('Doc. Suman Bisoi',textAlign:TextAlign.center,style: TextStyle(fontFamily: 'Shadows Into Light',fontSize:22.sp)),
                Text('Animal Welfare Chicago',textAlign:TextAlign.center,style: TextStyle(fontFamily: 'Sora',color:Colors.blueGrey,fontSize: 16.sp),),
                  ...
                  child: Row(
                      ...
                      children:[
                        ...
                        Container(
                          ...
                          child: Column(
                              children:[
                                Text('7+',style:TextStyle(fontSize: 18.sp,fontFamily: 'montserrat')),
                                SizedBox(height:5.h),
                ...
                Container(
                    ...
                    child:Column(
                      ...
                      children: [
                        ...
                        Text('Dr. Suman Bisoi is a highly qualified and experienced veterinarian from Chicago. He ia also a reputed member of Animal Welfare Community.',style: TextStyle(fontFamily: 'Montserrat',color:Colors.blueGrey)),
                      ],
                    )
                ),
                Padding(

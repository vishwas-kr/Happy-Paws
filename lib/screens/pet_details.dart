        ...
        body: Container(
            ...
            child: Column(
                ...
                children: [
                  ...
                  ClipOval(
                      child:
                          Image.network(PetProfile.profileImage, height: 200)),
                  SizedBox(height: 20.0),
                  Text(
                    '${loggedInUser.petName}',
                    textAlign: TextAlign.center,
                    style: TextStyle(fontFamily: 'Montserrat', fontSize: 24.0),
                  ),
                  Text(
                      'pet of ${loggedInUser.firstName} ${loggedInUser.secondName}',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontFamily: 'Sora', color: Colors.blueGrey)),
                  Text('Age: 5 Years',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontFamily: 'sora', color: Colors.blueGrey)),
                  ...
                  Padding(
                    ...
                    child: Text('Gallery',
                        style: TextStyle(
                            fontFamily: 'Montserrat', fontSize: 24.0)),
                  ),
                  Expanded(
                    child: Container(
